...
const whoData = {
  male: {
    // WHO 데이터도 koreanData와 동일한 구조로 준비
    height: {
      months: [0, 1, 2, 3, 6, 9, 12, 18, 24, 30, 36],
      percentiles: {
    ...
    weight: {
      ...
      months: [0, 1, 2, 3, 6, 9, 12, 18, 24, 30, 36],
      percentiles: {
        p3: [2.5, 3.4, 4.3, 5.0, 6.3, 7.1, 7.7, 8.6, 9.6, 10.5, 11.3],
        p10: [2.8, 3.8, 4.7, 5.4, 6.8, 7.6, 8.3, 9.2, 10.2, 11.1, 12.0],
        p25: [3.1, 4.2, 5.1, 5.8, 7.3, 8.2, 8.9, 9.9, 10.9, 11.9, 12.8],
        p50: [3.4, 4.5, 5.6, 6.3, 7.9, 8.8, 9.6, 10.7, 11.7, 12.7, 13.7],
        p75: [3.7, 5.0, 6.0, 6.9, 8.6, 9.5, 10.4, 11.5, 12.6, 13.7, 14.7],
        p90: [4.0, 5.4, 6.5, 7.4, 9.2, 10.3, 11.2, 12.4, 13.6, 14.7, 15.7],
        p97: [4.3, 5.8, 7.0, 8.0, 9.9, 11.0, 12.0, 13.3, 14.5, 15.7, 16.8]
      }
    },
    headCircumference: {
      // WHO 남아 머리둘레 데이터 (예시)
      months: [0, 1, 2, 3, 6, 9, 12, 18, 24, 30, 36],
      percentiles: {
        p3: [32.4, 35.1, 36.9, 38.2, 40.9, 42.3, 43.4, 44.7, 45.7, 46.4, 46.9],
        p10: [33.2, 35.8, 37.5, 38.8, 41.5, 42.9, 44.0, 45.3, 46.3, 46.9, 47.4],
        p25: [33.8, 36.5, 38.2, 39.5, 42.1, 43.5, 44.6, 45.9, 46.9, 47.5, 48.0],
        p50: [34.5, 37.2, 38.9, 40.2, 42.9, 44.3, 45.3, 46.6, 47.5, 48.1, 48.7],
        p75: [35.2, 38.0, 39.6, 40.9, 43.6, 44.9, 46.0, 47.3, 48.2, 48.8, 49.3],
        p90: [35.9, 38.7, 40.3, 41.6, 44.2, 45.6, 46.7, 48.0, 48.9, 49.5, 50.0],
        p97: [36.6, 39.4, 41.0, 42.3, 44.9, 46.3, 47.4, 48.7, 49.6, 50.2, 50.7]
      }
    }
  },
  female: {
    ...
    height: {
      months: [0, 1, 2, 3, 6, 9, 12, 18, 24, 30, 36],
      percentiles: {
        p3: [45.6, 50.0, 53.5, 56.2, 61.8, 65.8, 69.2, 73.6, 77.8, 81.2, 84.4],
        p10: [47.3, 51.7, 55.1, 57.9, 63.5, 67.6, 71.0, 75.5, 79.7, 83.2, 86.4],
        p25: [48.9, 53.2, 56.7, 59.5, 65.2, 69.3, 72.8, 77.3, 81.6, 85.0, 88.3],
        p50: [50.6, 54.9, 58.4, 61.2, 67.0, 71.1, 74.6, 79.2, 83.5, 87.0, 90.3],
        p75: [52.3, 56.6, 60.1, 62.9, 68.8, 72.9, 76.4, 81.0, 85.4, 88.9, 92.2],
        p90: [53.9, 58.2, 61.7, 64.5, 70.5, 74.6, 78.1, 82.8, 87.2, 90.7, 94.1],
        p97: [55.4, 59.7, 63.2, 66.0, 72.0, 76.1, 79.8, 84.5, 88.9, 92.5, 95.9]
      }
    },
    weight: {
      // WHO 여아 몸무게 데이터
